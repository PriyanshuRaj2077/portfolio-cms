...
const AdminApp = {
  ...
  async renderProjectsView(container) {
    container.innerHTML = `<div class="admin-card"><div class="admin-card-header"><h2 class="admin-card-title">Portfolio Projects</h2><button class="btn-admin btn-admin-primary">+ Add New Project</button></div><p style="color: var(--text-sub);">Manage featured projects, repository links, tags, and cover images.</p></div>`;
  },
